...
const GolangLogo = props => {
  ...
  return (
    <svg className={className} style={{width: '10%', top: '27.5%'}} xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 254.5 225" space="preserve">
    <g>
      <g>
        <g>
          <g>
